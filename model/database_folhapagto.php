...
{
const  dominio = 'http://bravoplataforma.bravobpo.com.br/folha-pagamento/';
const  path    = 'F:/wamp/www/plataforma/folha-pagamento/';
}
...
class folhapagto {	
	...
	public function escape($str, $html=true)
	{
		...
		if($html)
			return mysqli_real_escape_string($this->FolhaDB->mysqli_connection, strip_tags($str));
		else
