...
class funcionalidadeConst
{
	...
	const LINK_PORTAL = 'http://bravoplataforma.bravobpo.com.br/portalfornecedor/public/portalfornecedor/login';
	const LINK_FOLHA = 'http://bravoplataforma.bravobpo.com.br/folha-pagamento/login.php';
}
